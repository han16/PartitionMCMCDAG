...
source(paste(path, "partitionMCMCcode/initialisation/BHinit.R", sep="")) 
...
switch(as.character(MCMCtype),
  ...
  "2"={ # with new edge reversal
	iterations<-500000 #number of iterations in the chain
...
# 2 is new edge reversal move
  ...
  "3"={ # order MCMC
	iterations<-150000 #number of iterations in the chain
# Choose the probability of the different moves
...
# 5 is to stay still (officially needed for convergence)
  ...
  "5"={ # partition MCMC with edge reversal
	iterations<-56000 #number of iterations in the chain
# Choose the probability of the different moves
# 1 is swap two nodes from different partition elements
# 2 is to only swap nodes from adjacent elements
# 3 is to split or join partition elements
...
main="", col="blue",ylim=c(maxscore-13.8,maxscore+0.2))
  ...
  if((saveoutput==1)&&(seedset==1)){
    switch(as.character(MCMCtype),
    "1"={ # standard structure MCMC
  filetemp<-paste("./BHgraphs/structureBH",N,"its",iterations/1000,"seed",seednumber,filetypes[filetypey],sep="")
	save(DAGscores,file=paste("./BHgraphs/structureBHscores",N,"its",iterations/1000,"seed",seednumber,".RData",sep=""))
    },
    "2"={ # with new edge reversal
  filetemp<-paste("./BHgraphs/edgerevBH",N,"one",100*moveprobs[1],"its",iterations/1000,"seed",seednumber,filetypes[filetypey],sep="")
	save(DAGscores,file=paste("./BHgraphs/edgerevBHscores",N,"one",100*moveprobs[1],"its",iterations/1000,"seed",seednumber,".RData",sep=""))
    },
    "3"={ # order MCMC
	save(DAGscores,file=paste("./BHgraphs/orderBHscores",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"its",iterations/1000,"seed",seednumber,".RData",sep=""))
  filetemp<-paste("./BHgraphs/orderBH",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"its",iterations/1000,"seed",seednumber,filetypes[filetypey],sep="")
    },
    "4"={ # partition MCMC
	save(DAGscores,file=paste("./BHgraphs/partitionBHscores",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"three",100*moveprobs[3],"its",iterations/1000,"seed",seednumber,".RData",sep=""))
  filetemp<-paste("./BHgraphs/partitionBH",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"three",100*moveprobs[3],"its",iterations/1000,"seed",seednumber,filetypes[filetypey],sep="")
    },
    "5"={ # partition MCMC with edge reversal
	save(DAGscores,file=paste("./BHgraphs/partitionBHedgerevscores",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"three",100*moveprobs[3],"six",100*moveprobs[6],"its",iterations/1000,"seed",seednumber,".RData",sep=""))
  filetemp<-paste("./BHgraphs/partitionBHedgrev",N,"one",100*moveprobs[1],"two",100*moveprobs[2],"three",100*moveprobs[3],"six",100*moveprobs[6],"its",iterations/1000,"seed",seednumber,filetypes[filetypey],sep="")
    },
    {# if none is chosen, we have a problem
	print('Not implemented!')
    })
  ...
  if((saveoutput==1)&&(seedset==1)){
    switch(as.character(MCMCtype),
    "1"={ # standard structure MCMC
	save(maxyscores,file=paste("./BHgraphs/structureBHmax",iimin,"to",iimax,".RData",sep=""))
    },
    "2"={ # with new edge reversal
	save(maxyscores,file=paste("./BHgraphs/edgerevBHmax",iimin,"to",iimax,".RData",sep=""))
    },
    "3"={ # order MCMC
	save(maxyscores,file=paste("./BHgraphs/orderBHmax",iimin,"to",iimax,".RData",sep=""))
    },
    "4"={ # partition MCMC
	save(maxyscores,file=paste("./BHgraphs/partitionBHmax",iimin,"to",iimax,".RData",sep=""))
    },
    "5"={ # partition MCMC with edge reversal
	save(maxyscores,file=paste("./BHgraphs/partitionBHedgerevmax",iimin,"to",iimax,".RData",sep=""))
    },
    {# if none is chosen, we have a problem
	print('Not implemented!')
    })

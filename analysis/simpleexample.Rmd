---
title: "Run simpleexample.R"
author: "Shengtong"
date: "2018-11-06"
output: workflowr::wflow_html
---

"simpleexample.R" runs a small example on three nodes where the score is proportional to the number of edges in the DAG, different from BGe score for 5-node network example in Figure 1. 




```{r read-chunk, include=FALSE,eval=T}
path="C:/han/Projects/PartitionMCMCDAG/"
source(paste(path, "partitionMCMCcode/edgerevandstructure/structurefns.R", sep=""))
```

## Call source code and set up parameters 
...
dirname<-paste(path, "partitionMCMCcode/simpleexamplegraphs/")
...
* [listpossibleparents](listpossibleparents.html) list all possible parents
...
## Define different move types 

```{r, echo=T, cap="switch function", eval=T}
...
* [structure MCMC](structureMCMC.html)

* [order MCMC](orderMCMC.html)

* [partition MCMC](partitionMCMC.html)
